...
<template>
  <div class="relative bg-gray-900 text-gray-100 min-h-screen font-sans selection:bg-green-500 selection:text-white overflow-hidden">
    ...
    <div class="absolute top-0 -left-4 w-96 h-96 bg-purple-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
    
    <div class="absolute top-0 -right-4 w-96 h-96 bg-green-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
    
    <div class="absolute -bottom-8 left-20 w-96 h-96 bg-blue-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-4000"></div>

    <div class="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 brightness-100 contrast-150 z-0"></div>
    ...
    <div class="relative z-10">
        ...
        <section id="about" class="py-24 px-6 bg-gray-900/60 backdrop-blur-sm border-t border-gray-800/50">
          <div class="max-w-6xl mx-auto">
            ...
            <div class="mt-20">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div v-for="item in skills" :key="item._id" 
                         class="bg-gray-800/80 border border-gray-700 p-4 rounded hover:border-green-500 transition cursor-default text-center backdrop-blur-md">
            ...
            <div class="mt-20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div v-for="cert in certificates" :key="cert._id" class="group relative bg-gray-800/80 rounded-lg overflow-hidden border border-gray-700 hover:shadow-lg hover:border-green-500 transition duration-300">
        ...
        <section id="portfolio" class="py-24 px-6 bg-gray-800/80 backdrop-blur-md border-t border-gray-700/50">
            <div class="max-w-6xl mx-auto">
        ...
        <section id="contact" class="py-24 px-6 bg-gray-900/90 backdrop-blur-sm text-center relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
                    <a v-if="profile.email" :href="`https://mail.google.com/mail/?view=cm&fs=1&to=${profile.email}`" target="_blank" class="group bg-gray-800 p-6 rounded-xl border border-gray-700 hover:border-red-500 hover:bg-gray-800/80 transition flex flex-col items-center gap-4">
